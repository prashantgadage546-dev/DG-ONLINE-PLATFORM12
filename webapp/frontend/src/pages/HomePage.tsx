    ...
    <div className="min-h-screen navy-gradient">
      ...
      <header className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold text-white">DreamsGuider</span>
          </div>
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">Why Choose DreamsGuider?</h2>
      ...
      <footer className="border-t border-navy-700 py-8 mt-20">
        <div className="container mx-auto px-6 text-center text-gray-400">
          <p>&copy; 2026 DreamsGuider. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
